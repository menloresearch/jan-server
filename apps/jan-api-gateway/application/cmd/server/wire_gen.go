...
func CreateApplication() (*Application, error) {
	...
	conversationHandler := conversation2.NewConversationHandler(conversationService, userService)
	conversationAPI := conversations.NewConversationAPI(conversationHandler, userService, apiKeyService)
