...
// @Accept json
// @Produce json
// @Param request body conversationUseCase.CreateConversationRequest true "Create conversation request"
// @Success 200 {object} conversationUseCase.ConversationResponse "Created conversation"
