...
// GetCompletionStreamResponse collects all streaming data and returns a complete response
func (s *CompletionStreamHandler) GetCompletionStreamResponse(ctx context.Context, apiKey string, request openai.ChatCompletionRequest) (*ExtendedCompletionResponse, *common.Error) {
