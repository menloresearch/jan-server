...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/organization/projects/{proj_public_id}/providers": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/menlo_ai_jan-api-gateway_app_interfaces_http_responses.GeneralResponse-array_app_interfaces_http_routes_v1_organization_providers_ProviderResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/app_interfaces_http_routes_v1_organization_providers.ProviderRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/app_interfaces_http_routes_v1_organization_providers.ProviderResponse"
                        }
                    },
                    "400": {
        ...
        "/v1/organization/projects/{proj_public_id}/providers/{provider_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/menlo_ai_jan-api-gateway_app_interfaces_http_responses.GeneralResponse-app_interfaces_http_routes_v1_organization_providers_ProviderResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/app_interfaces_http_routes_v1_organization_providers.UpdateProviderRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/organization/providers/{provider_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "app_interfaces_http_routes_v1_conv.ModelResponse": {
            "type": "object",
            "properties": {
                "created": {
                    "type": "integer"
        ...
        "app_interfaces_http_routes_v1_conv.ModelsResponse": {
            ...
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/app_interfaces_http_routes_v1_conv.ModelResponse"
                    }
                },
                "object": {
                    "type": "string"
        ...
        "app_interfaces_http_routes_v1_organization_providers.ProviderRequest": {
            "type": "object",
            "required": [
                "api_key",
                "name",
        ...
        "app_interfaces_http_routes_v1_organization_providers.ProviderResponse": {
            "type": "object",
            "properties": {
                "active": {
                    "type": "boolean"
        ...
        "app_interfaces_http_routes_v1_organization_providers.UpdateProviderRequest": {
            "type": "object",
            "properties": {
                "active": {
                    "type": "boolean"
        ...
        "menlo_ai_jan-api-gateway_app_interfaces_http_responses.GeneralResponse-app_interfaces_http_routes_v1_organization_providers_ProviderResponse": {
            "type": "object",
            "properties": {
                "result": {
                    "$ref": "#/definitions/app_interfaces_http_routes_v1_organization_providers.ProviderResponse"
        ...
        "menlo_ai_jan-api-gateway_app_interfaces_http_responses.GeneralResponse-array_app_interfaces_http_routes_v1_organization_providers_ProviderResponse": {
            "type": "object",
            "properties": {
                "result": {
                    "type": "array",
