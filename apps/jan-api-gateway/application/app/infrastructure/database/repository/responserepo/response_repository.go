...
func (r *ResponseRepository) domainToDB(resp *response.Response) *dbschema.Response {
	return &dbschema.Response{
		...
		TopP:              resp.TopP,
		TopK:              resp.TopK,
		RepetitionPenalty: resp.RepetitionPenalty,
		Seed:              resp.Seed,
		Stop:              resp.Stop,
		PresencePenalty:   resp.PresencePenalty,
		FrequencyPenalty:  resp.FrequencyPenalty,
		LogitBias:         resp.LogitBias,
		ResponseFormat:    resp.ResponseFormat,
		Tools:             resp.Tools,
		ToolChoice:        resp.ToolChoice,
...
func (r *ResponseRepository) dbToDomain(dbResp *dbschema.Response) *response.Response {
	return &response.Response{
		ID:                dbResp.ID,
		PublicID:          dbResp.PublicID,
		UserID:            dbResp.UserID,
		ConversationID:    dbResp.ConversationID,
		Model:             dbResp.Model,
		Status:            response.ResponseStatus(dbResp.Status),
		Input:             dbResp.Input,
		Output:            dbResp.Output,
		SystemPrompt:      dbResp.SystemPrompt,
		MaxTokens:         dbResp.MaxTokens,
		Temperature:       dbResp.Temperature,
		TopP:              dbResp.TopP,
		TopK:              dbResp.TopK,
		RepetitionPenalty: dbResp.RepetitionPenalty,
		Seed:              dbResp.Seed,
		Stop:              dbResp.Stop,
		PresencePenalty:   dbResp.PresencePenalty,
		FrequencyPenalty:  dbResp.FrequencyPenalty,
		LogitBias:         dbResp.LogitBias,
		ResponseFormat:    dbResp.ResponseFormat,
		Tools:             dbResp.Tools,
		ToolChoice:        dbResp.ToolChoice,
		Metadata:          dbResp.Metadata,
		Stream:            dbResp.Stream,
		Background:        dbResp.Background,
		Timeout:           dbResp.Timeout,
		User:              dbResp.User,
		Usage:             dbResp.Usage,
		Error:             dbResp.Error,
		CompletedAt:       dbResp.CompletedAt,
		CancelledAt:       dbResp.CancelledAt,
		FailedAt:          dbResp.FailedAt,
